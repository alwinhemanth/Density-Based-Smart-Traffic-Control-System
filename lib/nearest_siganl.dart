            ...
            Expanded(
              child: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  String slat = data['latitude'];
                  String slon = data['longitude'];

                  return Card(
                    child: ListTile(
                      title: Text(data['signalname']),
                      trailing: Icon(Icons.location_on),
                      onTap: () async {
                        SharedPreferences sh = await SharedPreferences.getInstance();
                        sh.setString("slati", slat);
                        sh.setString("slongi", slon);

                        openMaps(); // assuming it opens maps based on those coordinates
                      },
                    ),
                  );
                },
