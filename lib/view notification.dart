...
class ViewReply extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyViewNotification(title: 'Reply'),
    );
  }
}

class MyViewNotification extends StatefulWidget {
  const MyViewNotification({super.key, required this.title});

  final String title;

  @override
  State<MyViewNotification> createState() => _MyViewNotificationState();
}

class _MyViewNotificationState extends State<MyViewNotification> {

  _MyViewNotificationState(){
    viewreply();
  }
  ...
  Future<void> viewreply() async {
    ...
    try {
      ...
      String url = '$urls/police_view_notification/';
      ...
      child: Scaffold(
        ...
        appBar: AppBar(
          leading: BackButton( onPressed:() {
            ...
            Navigator.push(
              context,
              MaterialPageRoute(builder: (context) => NewHomePolicePage(title: 'Traffic Police')),);
