...
import 'package:trafficdencity/newhomepage.dart';
...
class MyIsland extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyViewDensityPolicePage(title: 'Reply'),
    );
  }
}

class MyViewDensityPolicePage extends StatefulWidget {
  const MyViewDensityPolicePage({super.key, required this.title});

  final String title;

  @override
  State<MyViewDensityPolicePage> createState() => _MyViewDensityPolicePageState();
}

class _MyViewDensityPolicePageState extends State<MyViewDensityPolicePage> {

  _MyViewDensityPolicePageState(){
    MyIsland();
  }
  ...
  Future<void> MyIsland() async {
    ...
    try {
      ...
      String url = '$urls/police_view_island_density/';
