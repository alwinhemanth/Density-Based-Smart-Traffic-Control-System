...
class MyIsland extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      home: const MyViewIslandPolicePage(title: 'Reply'),
    );
  }
}

class MyViewIslandPolicePage extends StatefulWidget {
  const MyViewIslandPolicePage({super.key, required this.title});

  final String title;

  @override
  State<MyViewIslandPolicePage> createState() => _MyViewIslandPolicePageState();
}

class _MyViewIslandPolicePageState extends State<MyViewIslandPolicePage> {

  _MyViewIslandPolicePageState(){
    MyIsland();
  }
  ...
  Future<void> MyIsland() async {
    ...
    try {
      ...
      String url = '$urls/police_view_island/';
